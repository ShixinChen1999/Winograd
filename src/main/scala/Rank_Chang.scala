...
class Conter_pause extends Module{
  val io=IO(new Bundle{
    ...
    val goal_num=Input(UInt(8.W))//可配置
    val pulse=Input(Bool())
    val cnt=Output(UInt(8.W))
    val out_valid=Output(Bool())
  })

  val cnt_temp=RegInit(0.U(8.W))
  when(io.valid) {
...
class Rank_Change_IO extends Bundle with Config{
  ...
  val dIn=Input(Vec(RAM_GRP*RAM_NUM,UInt(OUT_BIT_WIDTH.W)))
  val dOut=Output(Vec(4,UInt(OUT_BIT_WIDTH.W)))
...
class Rank_Change extends Module with Config {
  ...
  val out_temp=VecInit(Seq.fill(4)(0.U(OUT_BIT_WIDTH.W)))




  val in_valid = RegNext(io.input_valid)
...
//  }
  ...
  val reg_1=VecInit(Seq.fill(4)(0.U(OUT_BIT_WIDTH.W)))
  val reg_2=VecInit(Seq.fill(4)(0.U(OUT_BIT_WIDTH.W)))
  val reg_3=VecInit(Seq.fill(4)(0.U(OUT_BIT_WIDTH.W)))
  val reg_4=VecInit(Seq.fill(4)(0.U(OUT_BIT_WIDTH.W)))
  val reg_end=VecInit(Seq.fill(8)(0.U(OUT_BIT_WIDTH.W)))
